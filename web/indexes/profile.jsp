                            ...
                            <div class="cart-info">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row gy-md-1 row-cols-2 row-cols-xl-1 row-cols-lg-1">
                                            <!-- Payment card 1 -->
                                            <div class="col">
                                                <article class="payment-card" style="--bg-color: #1e2e69">
                                                    ...
                                                    <div class="payment-card__top">
                                                        ...
                                                        <span class="payment-card__type">niggasCard</span>
                                                    </div>
                                            ...
                                            <div class="col">
                                                <article class="payment-card" style="--bg-color: #354151">
                                                    ...
                                                    <div class="payment-card__top">
                                                        ...
                                                        <span class="payment-card__type">N-wordPass</span>
                                                    </div>
                                                     <div class="payment-card__number">${up.cardNum}</div>
                                                    <div class="payment-card__bottom">
                                                        <div>
