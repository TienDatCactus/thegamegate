      ...
      <div class="auth__content">
        <div class="auth__content-inner">
          ...
          <div class="auth__message message message--success">
            We sent a bomb to your house , open it and receive the new password !
          </div>
          <form action="${pageContext.request.contextPath}/index-logined.html" class="form auth__form auth__form-forgot">
          ...
          <p class="auth__text">
            <a href="${pageContext.request.contextPath}/sign-in.jsp" class="auth__link auth__text-link">Back to Sign-in.</a>
          </p>
        </div>
      </div>
    </main>
