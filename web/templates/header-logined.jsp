        ...
        <c:choose>
            ...
            <c:otherwise >
                ...
                <div class="top-act__user">
                    <img
                        src="${pageContext.request.contextPath}/assets/assets/unrelated pics/casual-life-3d-profile-picture-of-man-in-green-shirt-and-orange-hat.png    "
                        alt=""
                    ...
                    <div class="act-dropdown top-act__dropdown">
                        <div class="act-dropdown__inner user-menu">
                            ...
                            <div class="user-menu__top">
                                <img src="${pageContext.request.contextPath}/assets/assets/unrelated pics/casual-life-3d-profile-picture-of-man-in-green-shirt-and-orange-hat.png" alt="" class="user-menu__avatar" />
                                <div>
                            ...
                            <ul class="user-menu__list">
                                ...
                                <li>
                                    <a href="/edit-personal-info.html" class="user-menu__link">Edit personal info</a>
                                </li>
                                <li class="user-menu__separate">
